            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-black border-bottom-on-white pb-3 mb-4">Feedback Form</h5>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="content" rows="7" placeholder="Enter Your experience with us"></textarea>
                                </div>
