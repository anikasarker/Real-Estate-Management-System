                ...
                <div class="row h-100 align-items-center">
                    <div class="col-lg-12">
                        <div class="text-white ">
                            <h1 class="mb-4" style="text-align:left;">Find Your 
                             Dream Place</h1>
                            <form method="post" action="propertygrid.php">
                                <div class="row" >
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="type" style="font-family: 'Marcellus SC', serif;">
                                                <option value="" style="font-family: 'Marcellus SC', serif;">Select Type</option>
                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="stype" style="font-family: 'Marcellus SC', serif;">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" style="    font-family: 'Marcellus SC', serif;"class="form-control" name="city" placeholder="Enter City" required>
                                        </div>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="text-box-one">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                        <div class="p-4 text-center hover-bg hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-search text-info flat-medium icon-success" aria-hidden="true"></i>
