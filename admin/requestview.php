            ...
            <div class="page-wrapper" style="background-color: bisque;">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title    ">Client Request</h3>
								<ul class="breadcrumb">
								...
								<h4 class="card-title    ">Request List</h4>
									...
									<table id="dynamic" class="table table-bordered ">
											...
											<?php
												...
												$query=mysqli_query($con,"select * from requestbook ");
												$cnt=1;
											...
											?>
                                                <tr>
													...
													<td><a href="requestdelete.php?id=<?php echo $row['0']; ?>"><button class="btn btn-danger">Delete</button></a>
													<a href="requestapprove.php?id=<?php echo $row['0']; ?>"><button class="btn btn-info">Approve</button></a></td>
