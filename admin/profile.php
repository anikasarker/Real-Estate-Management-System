							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" alt="User Image" src="assets/img/profiles/1.png">
										</a>
									</div>
										...
										<div class="col-lg-3">
											...
											<div class="card">
												<div class="card-body">
													...
													<button class="btn btn-info" type="button"><i class="fe fe-check-verified"></i> Active</button>
												</div>
											</div>
											<!-- /Account Status -->
