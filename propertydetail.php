    ...
    <div class="row">
        ...
        <div class="full-row">
            ...
            <div class="container bg-gray" >
                <h2 style=" font-family: 'Marcellus SC', serif; text-align:center;">Property Details</h2>
                <div class="row">
                ...
                <?php
                   ...
                   ?>
                    ...
                    <div class="col-lg-11 p-5 m-auto" >

                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1200px; height:700px; margin:30px auto 50px;">
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="1920" height="1080" src="admin/property/<?php echo $row['18']; ?>"  class="ls-bg" alt="" /> 
                                </div>
                        ...
                        <a href=" ">
                         <button type="button" class="bg-info d-table px-3 py-2 rounded text-white text-capitalize">For <?php echo $row['5']; ?></button> 
                         <a href="requestbook.php">
                         <button type="button" class="bg-info d-table px-3 py-2 rounded text-white text-capitalize" >Book Now </button></a>
                        <a href="calculate.php">
                        <button type="button" class="bg-info d-table px-3 py-2 rounded text-white text-capitalize">Calculate</button> </a>
                        </div>
                        </div>
                        ...
                        <div class="property-details">
                            <div class="bg-gray property-quantity px-4 pt-4 w-100">
                                <ul>
                                    ...
                                    <li><span class="text-secondary">  30%  </span> Interest Rate</li>
                                    <li><span class="text-secondary"><?php echo $row['24']; ?></span>Status</li>
                            ...
                            <div class="accordion" id="accordionExample">
                                <button class="bg-gray hover-bg-info hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> Floor Plans </button>
                                ...
                                <button class="bg-gray hover-bg-info hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Basement Floor</button>
                                ...
                                <button class="bg-gray hover-bg-info hover-text-white text-ordinary py-3 px-4 mb-1 w-100 text-left rounded position-relative collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Ground Floor</button>
                            ...
                            <div class="agent-contact pt-60">
                                <div class="row">
                                    <div class="col-sm-4 col-lg-3"> <img src="admin/assets/img/profiles/1.png" alt="" height="200" width="170"> </div>
                                    <div class="col-sm-8 col-lg-9">
                                        <div class="agent-data text-ordinary mt-sm-20">
                                            <h6 class="text-info text-capitalize">Anika</h6>
                                            <ul class="mb-3">
                                                <li>01987818351</li>
                                                <li>anikasarker246@gmail.com</li>
                                            </ul>

                                            <div class="mt-3 text-secondary hover-text-info">
                                                <ul>
